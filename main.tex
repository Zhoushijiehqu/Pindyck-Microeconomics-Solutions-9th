...
\begin{document}
	...
	\begin{itemize}[itemsep=0.5ex, parsep=0.5ex]
		...
		\item 前往 GitHub 仓库自行下载
		
		（https://github.com/Zhoushijiehqu/Pindyck-Microeconomics-Solutions-9th）
	\end{itemize}
	...
	% ★★★ 在这里把你的四个分卷拼装起来 ★★★
	\include{part_1}  % 包含 1-5 章
	\include{part_2}  % 包含 6-10 章
	\include{part_3}  % 包含 11-15 章
	\include{part_4}  % 包含 16-19 章
